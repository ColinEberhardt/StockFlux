...
!b||b.readyState!==WebSocket.CONNECTING&&b.readyState!==WebSocket.OPEN||b.close()},f.messageType=function(a){return arguments.length?(e=a,f):e},f.product=function(a){return arguments.length?(c=a,f):c},f}function ga(){function c(b){var c=a.time.second.offset(f.end(),-e*d);f.start(c).collapse(g.get(d)),f(b)}var d,e,f=b.data.feed.quandl(),g=a.map();return g.set(86400,"daily"),g.set(604800,"weekly"),c.candles=function(a){return arguments.length?(e=a,c):e},c.granularity=function(a){if(!arguments.length)return d;if(!g.has(a))throw new Error("Granularity of "+a+" is not supported.");return d=a,c},b.util.rebind(c,f,{end:"end",product:"dataset",apiKey:"apiKey"}),c}function ha(a){var b;return a&&a.quandl_error&&(b=a.quandl_error.message),b}function ia(){function c(){return{week1:za.data.period("Weekly",604800,{unit:a.time.week,value:1},"%b %d"),day1:za.data.period("Daily",86400,{unit:a.time.day,value:1},"%b %d"),hour1:za.data.period("1 Hr",3600,{unit:a.time.hour,value:1},"%b %d %Hh"),minute5:za.data.period("5 Min",300,{unit:a.time.minute,value:5},"%H:%M"),minute1:za.data.period("1 Min",60,{unit:a.time.minute,value:1},"%H:%M")}}function d(){return{generated:za.data.source(ca(),null,null),bitcoin:za.data.source(da(),ea,fa(),S),quandl:za.data.source(ga(),ha,null,null)}}function e(){return{generated:za.data.product("Data Generator","Data Generator",[j.day1],k.generated,".3s"),quandl:za.data.product("GOOG","GOOG",[j.day1,j.week1],k.quandl,".3s")}}function f(){var a=v();a.id=pa.uid();var c=za.menu.option("Candlestick","candlestick",a,"bf-icon-candlestick-series");c.isSelected=!0,c.option.extentAccessor=["high","low"];var d=b.series.ohlc();d.id=pa.uid();var e=za.menu.option("OHLC","ohlc",d,"bf-icon-ohlc-series");e.option.extentAccessor=["high","low"];var f=b.series.line().xValue(function(a){return a.date});f.id=pa.uid();var g=za.menu.option("Line","line",f,"bf-icon-line-series");g.option.extentAccessor="close";var h=b.series.point().xValue(function(a){return a.date});h.id=pa.uid();var i=za.menu.option("Point","point",h,"bf-icon-point-series");i.option.extentAccessor="close";var j=b.series.area().xValue(function(a){return a.date});j.id=pa.uid();var k=za.menu.option("Area","area",j,"bf-icon-area-series");k.option.extentAccessor="close";var l=za.menu.dropdownConfig(null,!1,!0,!0),m=[c,e,g,i,k];return za.menu.selector(l,m)}function g(){var a=sa.secondary,c=b.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).xValue(function(a){return a.date}).yValue(function(a){return a.movingAverage});c.id=pa.uid();var d=za.menu.option("Moving Average","movingAverage",c,"bf-icon-moving-average-indicator",!0);d.option.extentAccessor=function(a){return a.movingAverage};var e=b.indicator.renderer.bollingerBands();e.id=pa.uid();var f=za.menu.option("Bollinger Bands","bollinger",e,"bf-icon-bollinger-bands-indicator",!0);f.option.extentAccessor=[function(a){return a.bollingerBands.lower},function(a){return a.bollingerBands.upper}];var g=[d,f,za.menu.option("Relative Strength Index","secondary-rsi",a.rsi(),"bf-icon-rsi-indicator",!1),za.menu.option("MACD","secondary-macd",a.macd(),"bf-icon-macd-indicator",!1),za.menu.option("Volume","secondary-volume",a.volume(),"bf-icon-bar-series",!1)];return g}function h(){var a=za.menu.dropdownConfig("Add Indicator",!1,!0);return za.menu.selector(a,g())}function i(){return{seriesSelector:f(),indicatorSelector:h()}}var j=c(),k=d(),l=e();return{periods:j,sources:k,primaryChart:za.chart.primary(l.generated),secondaryChart:za.chart.secondary(l.generated),selectors:i(),xAxis:za.chart.xAxis(j.day1),nav:za.chart.nav(),navReset:za.chart.navigationReset(),headMenu:za.menu.head([l.generated,l.quandl],l.generated,j.day1),legend:za.chart.legend(l.generated,j.day1),overlay:za.menu.overlay([l.generated,l.quandl],l.generated),notificationMessages:za.notification.messages()}}function ja(b){a.json("https://api.exchange.coinbase.com/products",function(a,c){return a?void b(a):void b(a,c)})}function ka(a,b,c,d){return a.map(function(a){return za.data.product(a.id,a.id,d.get(a.id)||c,b)})}function la(){function c(){V&&(V=!1),X&&F.suspendLayout(!1),F.primary.datum(P.primaryChart).call(R.primary),F.legend.datum(P.legend).call(R.legend),F.secondaries.datum(P.secondaryChart).filter(function(a,b){return b<R.secondaries.length}).each(function(b,c){a.select(this).attr("class","secondary-container "+R.secondaries[c].valueString).call(R.secondaries[c].option)}),F.xAxis.datum(P.xAxis).call(R.xAxis),F.navbar.datum(P.nav).call(R.navbar),F.app.select("#navbar-reset").datum(P.navReset).call(I),F.app.select(".head-menu").datum(P.headMenu).call(H),F.app.selectAll(".selectors").datum(P.selectors).call(J),F.app.select("#notifications").datum(P.notificationMessages).call(K),F.overlay.datum(P.overlay).call(G),X&&(F.suspendLayout(!0),X=!1)}function d(){X=!0,pa.layout(F,R)}function e(){a.select(window).on("resize",function(){d(),W()})}function f(a){P.notificationMessages.messages.unshift(N(a))}function g(a){var b=[a[0],a[1]];P.primaryChart.viewDomain=b,P.secondaryChart.viewDomain=b,P.xAxis.viewDomain=b,P.nav.viewDomain=b;var c=pa.domain.trackingLatestData(P.primaryChart.viewDomain,P.primaryChart.data);P.primaryChart.trackingLatest=c,P.secondaryChart.trackingLatest=c,P.nav.trackingLatest=c,P.navReset.trackingLatest=c,W()}function h(a){a.isSelected=!a.isSelected,z(),W()}function i(a){a.isSelected=!a.isSelected,A(),W()}function j(a){P.legend.data=a,W()}function k(a,b){var c;c=b.streamingNotificationFormatter?b.streamingNotificationFormatter(a):S(a),c&&(f(c),W())}function l(){var a=P.primaryChart.data,c=b.util.extent().fields("date")(a),d=pa.domain.moveToLatest(c,a,U);g(d)}function m(a,b){var c='<div class="spinner"></div>',d='<div class="content alert alert-info">'+b+"</div>";F.app.select("#loading-status-message").classed("hidden",!(a||b)).html(b?d:c)}function n(a){P.primaryChart.data=a,P.secondaryChart.data=a,P.nav.data=a}function o(a){P.headMenu.selectedProduct=a,P.primaryChart.product=a,P.secondaryChart.product=a,P.legend.product=a,P.overlay.selectedProduct=a}function p(a){P.headMenu.selectedPeriod=a,P.xAxis.period=a,P.legend.period=a}function q(a){m(!0),o(a),p(a.periods[0]),Q(a.periods[0].seconds,a)}function r(){return sa.primary().on(qa.crosshairChange,j).on(qa.viewChange,g)}function s(){return sa.nav().on(qa.viewChange,g)}function t(){return ta.navigationReset().on(qa.resetToLatest,l)}function u(){return L().on(qa.newTrade,function(a,b){if(n(a),P.primaryChart.trackingLatest){var c=pa.domain.moveToLatest(P.primaryChart.viewDomain,P.primaryChart.data);g(c)}}).on(qa.historicDataLoaded,function(a,b){m(!1),n(a),P.legend.data=null,l(),d()}).on(qa.historicFeedError,function(a,b){m(!1,"Error loading data. Please make your selection again, or refresh the page.");var c="";try{var d=JSON.parse(a.responseText),e=b.historicNotificationFormatter(d);e&&(c=". "+e)}catch(g){c=""}var h=a.statusText||"Unknown reason.",i="Error getting historic data: "+h+c;f(i),W()}).on(qa.streamingFeedError,k).on(qa.streamingFeedClose,k)}function v(){return ta.head().on(qa.dataProductChange,function(a){q(a.option),W()}).on(qa.dataPeriodChange,function(a){m(!0),p(a.option),Q(a.option.seconds),W()}).on(qa.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){P.primaryChart.indicators.forEach(x),R.secondaries.forEach(x),z(),A(),W()})}function w(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function x(a){a.isSelected=!1}function y(){return ta.selectors().on(qa.primaryChartSeriesChange,function(a){P.primaryChart.series=a,w(a,P.selectors.seriesSelector.options),W()}).on(qa.primaryChartIndicatorChange,h).on(qa.secondaryChartChange,i)}function z(){P.primaryChart.indicators=P.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&a.isPrimary}),P.overlay.primaryIndicators=P.primaryChart.indicators}function A(){R.secondaries=P.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&!a.isPrimary}),
// TODO: This doesn't seem to be a concern of menu.
R.secondaries.forEach(function(a){a.option.on(qa.viewChange,g)}),P.overlay.secondaryIndicators=R.secondaries,
// TODO: Remove .remove! (could a secondary chart group component manage this?).
F.secondaries.selectAll("*").remove(),d()}function B(){return ta.overlay().on(qa.primaryChartIndicatorChange,h).on(qa.secondaryChartChange,i).on(qa.dataProductChange,function(a){q(a.option),W()})}function C(a){P.notificationMessages.messages=P.notificationMessages.messages.filter(function(b){return b.id!==a}),W()}function D(){return ua.toast().on(qa.notificationClose,C)}function E(b,c){if(b){var d=b.statusText||"Unknown reason.",e="Error retrieving Coinbase products: "+d;P.notificationMessages.messages.unshift(N(e))}else{var f=[P.periods.hour1,P.periods.day1],g=a.map();g.set("BTC-USD",[P.periods.minute1,P.periods.minute5,P.periods.hour1,P.periods.day1]);var h=ka(c,P.sources.bitcoin,f,g);P.headMenu.products=P.overlay.products=P.headMenu.products.concat(h)}W()}var F,G,H,I,J,K,M='<div class="container-fluid">         <div id="notifications"></div>         <div id="loading-status-message"></div>         <div class="row head-menu head-row">             <div class="col-md-12 head-sub-row">                 <div id="product-dropdown" class="dropdown product-dropdown"></div>                 <div class="selectors">                     <div class="series-dropdown dropdown selector-dropdown"></div>                     <div class="indicator-dropdown dropdown selector-dropdown"></div>                     <div id="mobile-period-selector" class="dropdown"></div>                 </div>                 <div id="period-selector"></div>                 <span id="clear-indicators" class="icon bf-icon-delete delete-button"></span>             </div>         </div>         <div class="row primary-row">             <div id="charts" class="col-md-12">                 <div id="charts-container">                     <svg id="primary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <svg class="secondary-container"></svg>                     <div class="x-axis-row">                         <svg id="x-axis-container"></svg>                     </div>                     <div id="navbar-row">                         <svg id="navbar-container"></svg>                         <svg id="navbar-reset"></svg>                     </div>                 </div>                 <div id="overlay">                     <div id="overlay-primary-container">                         <div id="overlay-primary-head">                             <div class="selectors">                                 <div id="mobile-product-dropdown" class="dropdown"></div>                                 <div class="series-dropdown dropdown selector-dropdown"></div>                                 <div class="indicator-dropdown dropdown selector-dropdown"></div>                             </div>                             <div id="legend">                                 <svg id="tooltip"></svg>                             </div>                         </div>                         <div id="overlay-primary-bottom">                             <div class="edit-indicator-container"></div>                         </div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="overlay-secondary-container">                         <div class="edit-indicator-container"></div>                     </div>                     <div class="x-axis-row"></div>                     <div id="overlay-navbar-row"></div>                 </div>             </div>         </div>     </div>',O={},P=ia(),Q=u(),R={primary:void 0,secondaries:[],xAxis:sa.xAxis(),navbar:void 0,legend:sa.legend()},T=!1,U=.2,V=!0,W=b.util.render(c),X=!0;return O.fetchCoinbaseProducts=function(a){return arguments.length?(T=a,O):T},O.changeQuandlProduct=function(a){var b=va.product(a,a,[P.periods.day1],P.sources.quandl,".3s"),c=P.headMenu.products.some(function(a){return a.id===b.id}),d=P.overlay.products.some(function(a){return a.id===b.id});c||P.headMenu.products.push(b),d||P.overlay.products.push(b),q(b),V||W()},O.proportionOfDataToDisplayByDefault=function(a){return arguments.length?(U=a,O):U},O.run=function(b){if(!b)throw new Error("An element must be specified when running the application.");var c=a.select(b);c.html(M);var f=c.select("#charts"),g=c.select("#charts-container"),h=c.select("#overlay");F={app:c,charts:g,chartsAndOverlay:f,primary:g.select("#primary-container"),secondaries:g.selectAll(".secondary-container"),xAxis:g.select("#x-axis-container"),navbar:g.select("#navbar-container"),overlay:h,overlaySecondaries:h.selectAll(".overlay-secondary-container"),legend:c.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},R.primary=r(),R.navbar=s(),H=v(),I=t(),J=y(),G=B(),K=D(),d(),e(),Q(P.headMenu.selectedPeriod.seconds,P.headMenu.selectedProduct),T?ja(E):P.sources.bitcoin&&delete P.sources.bitcoin},b.util.rebind(O,P.sources.quandl.historicFeed,{quandlApiKey:"apiKey"}),b.util.rebind(O,Q,{periodsOfDataToFetch:"candlesOfData"}),O}a="default"in a?a["default"]:a,b="default"in b?b["default"]:b,c="default"in c?c["default"]:c;var ma={centerOnDate:d,filterDataInDateRange:e,moveToLatest:f,trackingLatestData:g},na=!1,oa=0,pa={domain:ma,layout:h,uid:i,width:j,debounce:k,throttle:l},qa={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",streamingFeedClose:"streamingFeedClose",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange",notificationClose:"notificationClose"},ra={base:n,macd:o,rsi:p,volume:q},sa={legend:s,nav:r,primary:z,xAxis:t,secondary:ra},ta={head:E,selectors:F,navigationReset:G,overlay:I},ua={toast:M},va={period:O,product:P,source:Q},wa={head:U,periodAdaptor:B,productAdaptor:A,overlay:V,dropdownConfig:T,option:u,selector:W},xa={legend:X,nav:Y,navigationReset:Z,primary:$,secondary:_,xAxis:aa},ya={message:N,messages:ba},za={menu:wa,chart:xa,data:va,notification:ya},Aa={app:la};return Aa});